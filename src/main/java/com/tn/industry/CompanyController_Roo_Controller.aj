...
import com.tn.industry.CompanyController;
...
privileged aspect CompanyController_Roo_Controller {
    ...
    void CompanyController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("company_intoproduction_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
