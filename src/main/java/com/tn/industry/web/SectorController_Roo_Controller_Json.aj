...
import com.tn.industry.web.SectorController;
...
privileged aspect SectorController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> SectorController.updateFromJson(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        Sector sector = Sector.fromJsonToSector(json);
    ...
    public ResponseEntity<String> SectorController.updateFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        for (Sector sector: Sector.fromJsonArrayToSectors(json)) {
            if (sector.merge() == null) {
