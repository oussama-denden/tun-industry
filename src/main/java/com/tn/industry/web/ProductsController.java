...
public class ProductsController {
	...
	@RequestMapping(value = "/activity/{id}", headers = "Accept=application/json")
	@ResponseBody
	public ResponseEntity<String> activityProducts(@PathVariable("id") Long id) {
		...
		Logger.getLogger(ActivityBranch.class).log(Level.INFO,
				"activity products : " + productses.size());
